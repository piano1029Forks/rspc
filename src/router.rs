    ...
    TCtx: 'static,
{
    ...
    pub fn export_ts<TPath: AsRef<Path>>(&self, export_path: TPath, export_configuration: Option<ExportConfiguration>) -> Result<(), ExportError> {
        ...
        let config = export_configuration.unwrap_or(ExportConfiguration::new().bigint(
